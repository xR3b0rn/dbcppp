...
const char* g_kcd_xsd =
    ...
    ""
    "-->"
    "<xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\" targetNamespace=\"http://kayak.2codeornot2code.org/1.0\" xmlns:kcd=\"http://kayak.2codeornot2code.org/1.0\" xmlns=\"http://kayak.2codeornot2code.org/1.0\">"
