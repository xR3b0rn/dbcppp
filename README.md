![travis-ci](https://travis-ci.org/xR3b0rn/dbcppp.svg?branch=master "travis-ci")
# dbcppp (DBC C++ parser)
...
```
# Known issues
* decoding function for float/double is failing on maschines not using IEEE 754 float/double encoding
# Similar projects
